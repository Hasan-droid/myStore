...
//put all props in console.log to see what is passed to this component and name them accordingly
// console.log(
//   "CartMediumSizeView props:",
//   item,
      ...
      <AnimatePresence>
        ...
        >
          <Grid
            ...
            // transition={{ duration: 0.5 }}
          >
            <Box position="relative" cursor="pointer" onClick={() => handleShowImageForPhone(item.id)}>
